...
module.exports = {
  ...
  "screens": [{
    ...
    "actions": [{
      ...
      "outcome": "negative",
      "text": "Minden hi\xE1ba. Teljes stresszben \xE9s szorong\xE1sban t\xF6lt\xF6d az \xE9jszak\xE1t, nem kev\xE9s alkohol t\xE1rsas\xE1g\xE1ban. Hajnalban bev\xE1nszorogsz az irod\xE1ba, fejben m\xE1r a felmond\xF3 leveled negyedik verzi\xF3j\xE1t fogalmazgatod.",
    ...
    "outcome": "endgame",
    "actions": [{
      "title": "Feliratkozom a toplistára!",
      "action": "highscore"
    }]
  }]
};
...
},{"./Money_glitter_v1-min.gif":"img/Money_glitter_v1-min.gif","./Money_glitter_v2-min.gif":"img/Money_glitter_v2-min.gif","./Santa_cloud-min.gif":"img/Santa_cloud-min.gif","./coin.gif":"img/coin.gif","./Santa_hand_-min.gif":"img/Santa_hand_-min.gif","./cover_1.png":"img/cover_1.png","./cover_10.png":"img/cover_10.png","./cover_11.png":"img/cover_11.png","./cover_12.png":"img/cover_12.png","./cover_14.png":"img/cover_14.png","./cover_13.png":"img/cover_13.png","./cover_15.png":"img/cover_15.png","./cover_16.png":"img/cover_16.png","./cover_17.png":"img/cover_17.png","./cover_18.png":"img/cover_18.png","./cover_19.png":"img/cover_19.png","./cover_2.png":"img/cover_2.png","./cover_20.png":"img/cover_20.png","./cover_3.gif":"img/cover_3.gif","./cover_21.png":"img/cover_21.png","./cover_3.png":"img/cover_3.png","./cover_4.gif":"img/cover_4.gif","./cover_4.png":"img/cover_4.png","./cover_5.gif":"img/cover_5.gif","./cover_5.png":"img/cover_5.png","./cover_6.png":"img/cover_6.png","./cover_7.png":"img/cover_7.png","./cover_8.png":"img/cover_8.png","./cover_gamewon.png":"img/cover_gamewon.png","./cover_9.png":"img/cover_9.png","./favicon-16.png":"img/favicon-16.png","./cover_highscore.png":"img/cover_highscore.png","./favicon-180.png":"img/favicon-180.png","./fr_opengraph.jpg":"img/fr_opengraph.jpg","./favicon-32.png":"img/favicon-32.png","./icon_success.png":"img/icon_success.png","./intro_graphics.png":"img/intro_graphics.png","./icon_error.png":"img/icon_error.png","./intro_logo.png":"img/intro_logo.png","./logo.png":"img/logo.png","./lose_cover.png":"img/lose_cover.png","./lose_icon.png":"img/lose_icon.png","./mistletoe.png":"img/mistletoe.png","./santa_couple_2-min.gif":"img/santa_couple_2-min.gif","./win_cover.png":"img/win_cover.png","./section.svg":"img/section.svg","./win_icon.png":"img/win_icon.png"}],"js/gameController.js":[function(require,module,exports) {
"use strict";
...
var _TextPlugin = _interopRequireDefault(require("gsap/TextPlugin"));
...
var GameController = /*#__PURE__*/function () {
  function GameController(datasource, root) {
    var startProgress = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

    _classCallCheck(this, GameController);

    _gsap.gsap.registerPlugin(_TextPlugin.default); // gsap.ticker.fps(12); //Set fps to five for retro feelings
  ...
  _createClass(GameController, [{
    ...
    value: function addScreen(data) {
      ...
      if (!visible) {
        scr_dom.hide();
      } //hide if visible set to false


      data.actions.forEach(function (element, index) {
        var tmp_button = (0, _cashDom.default)("<button class=\"nes-btn\" data-id=\"".concat(_this.progress, "/").concat(index, "\" data-type=\"").concat(element.action, "\">").concat(element.title, "</button>")).appendTo(scr_dom.find('div.buttons'));
        tmp_button.on('click', function (e) {
    ...
    value: function _handleClick(e) {
      ...
      var action = e.srcElement.dataset.type; //start the timer if it's not yet started
      ...
      switch (action) {
        case "next":
          this._nextScreen(e.srcElement);

          break;

        case "render_outcome":
          this._renderOutcome(e.srcElement, this._ds.screens[idstr[0]].actions[idstr[1]]);
    ...
    key: "_nextScreen",
    value: function _nextScreen(current) {
      this.progress += 1;
    ...
    key: "_renderOutcome",
    value: function _renderOutcome(current, screenData) {
...
var _ScrollToPlugin = _interopRequireDefault(require("gsap/ScrollToPlugin"));

var _TextPlugin = _interopRequireDefault(require("gsap/TextPlugin"));

var _gamedata = _interopRequireDefault(require("../data/gamedata.json"));

var _gameController = _interopRequireDefault(require("./gameController.js"));
...
(0, _cashDom.default)(function () {
  (0, _cashDom.default)(document).ready(function () {
    ...
    (0, _cashDom.default)("#start").on('click', function (e) {
    ...
    (0, _cashDom.default)("#back").on('click', function (e) {
      ...
      (0, _cashDom.default)('div.intro').show();
    ...
    (0, _cashDom.default)("#register").on('click', function (e) {
      ...
      fetch(_gamedata.default.register_url, {
        ...
        body: JSON.stringify({
          name: (0, _cashDom.default)('input#name')[0].value,
          email: (0, _cashDom.default)('input#email')[0].value,
  ...
  function showHighScore() {
    (0, _cashDom.default)('div.highscore').show();
    ...
    showLoading();
    fetch(_gamedata.default.highscore_url).then(function (res) {
      return res.json();
    }).then(function (result) {
      var target = (0, _cashDom.default)('.highscore table tbody').empty();
      result.forEach(function (item, index) {
        (0, _cashDom.default)("<tr>\n        <td>".concat(index + 1, ".</td>\n        <td>").concat(item.name, "</td>\n        <td>$").concat(Number(item.score).toLocaleString(), "</td>\n        </tr>")).appendTo((0, _cashDom.default)('.highscore table tbody'));
        (0, _cashDom.default)('.highscore table thead').append('<span>das</span>');
      });
      hideLoading();
    }).catch(function (err) {
  ...
  function showLoading() {
    (0, _cashDom.default)("div.loading").show();
    (0, _cashDom.default)('#loading-bar').show();
    (0, _cashDom.default)('div.error').hide();
    (0, _cashDom.default)('div.success').hide();
    (0, _cashDom.default)("div.loading").addClass('blocker');
    (0, _cashDom.default)("div.success, div.error").hide();
  ...
  function setLoadingScreen(type, func) {
    ...
    if (type == 'success') {
      (0, _cashDom.default)('div.error').hide();
      (0, _cashDom.default)("div.loading").data("next", func);

      _gsap.gsap.to('#loading-bar', .5, {
        autoAlpha: 0,
        display: "none",
        onComplete: function onComplete() {
          (0, _cashDom.default)('div.success').show();

          _gsap.gsap.fromTo('div.success', .5, {
            autoAlpha: 0
          }, {
            autoAlpha: 1
          });
      ...
      _gsap.gsap.to('#loading-bar', .5, {
        ...
        display: "none",
        onComplete: function onComplete() {
          (0, _cashDom.default)('div.error').show();

          _gsap.gsap.fromTo('div.error', .5, {
            autoAlpha: 0
          }, {
            autoAlpha: 1
          });
  ...
  (0, _cashDom.default)('div.loading').on('click', function (e) {
